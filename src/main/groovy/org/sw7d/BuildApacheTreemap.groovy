...
class BuildApacheTreemap {
  ...
  static groups = ['apache', 'creadur','cxf','webservices', 'tuscany', 'tiles', 'tapestry', 'redback', 'myfaces', 'qpid','karaf', 'directory','activemq','axis',
          'hadoop','harmony', 'lucene','manifoldcf', 'mina', 'jackrabbit','james','servicemix', 'geronimo', 'struts', 'maven', 'log4j', 'tomcat', 'incubator','commons']
  ...
  static void main(args) {
      ...
      search.results.items.sort{it.name}.each {
